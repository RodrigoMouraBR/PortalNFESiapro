...
namespace PortalNFE.Orders.Data.Context
{
    public class PortalNFEOrdersContext : DbContext, IUnitOfWork
    {
        public PortalNFEOrdersContext(DbContextOptions<PortalNFEOrdersContext> options) : base(options)
        {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(PortalNFEOrdersContext).Assembly);
