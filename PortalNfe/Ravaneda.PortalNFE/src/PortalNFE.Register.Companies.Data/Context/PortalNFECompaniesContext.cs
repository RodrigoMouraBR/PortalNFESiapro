...
{
    public class PortalNFECompaniesContext : DbContext, IUnitOfWork
    {
        public PortalNFECompaniesContext(DbContextOptions<PortalNFECompaniesContext> options) : base(options) 
        {           
        }

        public DbSet<Company> Companies { get; set; }
        public DbSet<CompanyAddress> CompaniesAddresses { get; set; }
        public DbSet<CompanyAffiliate> Affiliates { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(PortalNFECompaniesContext).Assembly);
