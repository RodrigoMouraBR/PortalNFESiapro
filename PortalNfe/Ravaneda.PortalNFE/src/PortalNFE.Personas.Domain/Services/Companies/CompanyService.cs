...
using PortalNFE.Personas.Domain.Interfaces.Repositories.Companies;
using PortalNFE.Personas.Domain.Interfaces.Services.Companies;
using PortalNFE.Personas.Domain.Models.Companies;
using PortalNFE.Personas.Domain.Validations.Companies;

namespace PortalNFE.Personas.Domain.Services.Companies
{
